...
# ------ Create Window ------
win_svc = sg.Window(
    "My Car Service History", layout, size=(1000, 600), resizable=False
).Finalize()
...
while True:
    ...
    if ev_1 == "Edit Record" and not win_edit_active:
        ...
        try:
            ...
            while True:
                ...
                # prevent user from entering invalid number
                    ...
                    (
                        [val_2["-MILE-"], win_edit["-MILE-"]],
                        [val_2["-NXTMILE-"], win_edit["-NXTMILE-"]],
                    )
                ):
                    continue
                # prevent user from entering invalid float
                elif not is_valid_float(
                    (
                        [val_2["-LAB-"], win_edit["-LAB-"]],
                        [val_2["-AMT-"], win_edit["-AMT-"]],
                    )
                ):
                    continue
                    ...
                    if is_field_empty(
                        (
                            [val_2["-SVCDATE-"], "Service Date"],
                            [val_2["-MODEL-"], "Car Model"],
                            [val_2["-PLATE-"], "Plate No"],
                            [val_2["-WKSHP-"], "Workshop"],
                            [val_2["-MILE-"], "Mileage"],
                            [val_2["-NXTMILE-"], "Next Mileage"],
                            [val_2["-NSVCDATE-"], "Next Date"],
                            [val_2["-LAB-"], "Labor Cost"],
                            [val_2["-AMT-"], "Amount"],
                        )
                    ):
                        continue
                    ...
                    service.update_record(
                        row_id,
                        val_2["-SVCDATE-"],
                        carinfo.GetModelId(val_2["-MODEL-"]),
                        val_2["-PLATE-"],
                        val_2["-WKSHP-"],
                        val_2["-MILE-"],
                        val_2["-NXTMILE-"],
        ...
        if butt == "Yes":
            ...
            # refresh table
            win_svc["-TABLE-"].Update(service.list_all_records2())
        ...
        try:
            ...
            win_add = sg.Window(
                title="Add New Service", size=(800, 600), layout=layout3
            )
            ...
            while True:
                ...
                # prevent user from entering invalid number
                    ...
                    (
                        [val_3["-MILE-"], win_add["-MILE-"]],
                        [val_3["-NXTMILE-"], win_add["-NXTMILE-"]],
                    )
                ):
                    continue
                # prevent user from entering invalid float
                    ...
                    (
                        [val_3["-LAB-"], win_add["-LAB-"]],
                        [val_3["-AMT-"], win_add["-AMT-"]],
                    )
                ):
                    continue
                # user click button Ok
                    ...
                    if is_field_empty(
                        (
                            [val_3["-SVCDATE-"], "Service Date"],
                            [val_3["-MODEL-"], "Car Model"],
                            [val_3["-PLATE-"], "Plate No"],
                            [val_3["-WKSHP-"], "Workshop"],
                            [val_3["-MILE-"], "Mileage"],
                            [val_3["-NXTMILE-"], "Next Mileage"],
                            [val_3["-NSVCDATE-"], "Next Date"],
                            [val_3["-LAB-"], "Labor Cost"],
                            [val_3["-AMT-"], "Amount"],
                        )
                    ):
                        continue
                    ...
                    service.add_record(
                        val_3["-SVCDATE-"],
                        carinfo.GetModelId(val_3["-MODEL-"]),
                        val_3["-PLATE-"],
                        val_3["-WKSHP-"],
                        val_3["-MILE-"],
                        val_3["-NXTMILE-"],
        ...
        # ------ Create Window ------
        win_spart = sg.Window(
            "Spare Parts Info", layout, size=(700, 600), resizable=False
        ).Finalize()
        row_id = 0
        while True:
            ...
            if ev_4 is None or ev_4 == "Close":
                ...
                win_spart_edit = sg.Window(
                    "Edit Spare Parts", layout, size=(700, 600), resizable=False
                ).Finalize()
                while True:
                    ...
                    # prevent user from entering invalid float
                        ...
                        (
                            [val_5["-PRICE-"], win_spart_edit["-PRICE-"]],
                            [val_5["-DISC-"], win_spart_edit["-DISC-"]],
                            [val_5["-AMT-"], win_spart_edit["-AMT-"]],
                        )
                    ):
                        continue
                        ...
                        win_spart_edit_active = (
                            False  # set flag window spare part active = False
                        )
                        # update spare part record
                        svc_db.update_part_record(
                            int(val_5["-PID-"]),
                            val_5["-SID-"],
                            val_5["-SVCDATE-"],
                            val_5["-PNAME-"],
                        ...
                        win_spart["-PTABLE-"].Update(
                            val_3=svc_db.get_record_parts(svc_id)
                        )
                ...
                # ------ Open the Spare Part Edit Window  ------
                win_spart_add = sg.Window(
                    "Add Spare Parts", layout, size=(700, 600), resizable=False
                ).Finalize()
                while True:
                    ...
                    # prevent user from entering invalid float
                        ...
                        (
                            [val_6["-PRICE-"], win_spart_add["-PRICE-"]],
                            [val_6["-DISC-"], win_spart_add["-DISC-"]],
                            [val_6["-AMT-"], win_spart_add["-AMT-"]],
                        )
                    ):
                        continue
                        ...
                        win_spart_add_active = (
                            False  # set flag window spare part active = False
                        )
                        # save the new spare part record
                        svc_db.add_part_record(
                            val_6["-SID-"],
                            val_6["-SVCDATE-"],
                            val_6["-PNAME-"],
                            val_6["-QTY-"],
                ...
                butt = sg.PopupYesNo(
                    "Are you sure you want to delete record part id "
                    + str(sparts_one_rec[0])
                )
                if butt == "Yes":
